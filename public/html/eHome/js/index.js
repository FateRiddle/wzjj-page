...
var timer = setInterval(function() {
	oLb[0].style.left = (oLb[0].offsetLeft - oLb[0].offsetWidth / 4) + "px";
	if(oLb[0].offsetLeft == -oLb[0].offsetWidth / 4 * 3) {
		oLb[0].style.transition = 0;
...
for(var j = 0; j < oAd.length; j++) {
	...
	oAd[j].onclick = function() {
		...
		oPi[0].style.backgroundImage = "url('../images/bg" + this.index + '-' + '0' + ".png')";
		oPs[0].innerHTML = '客厅'
	};
	for(var i = 0; i < oPk.length; i++) {
		...
		oPk[i].onmouseover = function() {
			...
			oPi[0].style.backgroundImage = "url('../images/bg" + subscript + '-' + this.index + ".png')";
		}
	}
}
